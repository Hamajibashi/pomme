<template>
  ...
  <div
    style="background-image: url('https://images.unsplash.com/photo-1530088172039-5aa64cd6d3b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80'); height:300px; background-size:cover; background-position:center center; background-attachment:fixed;"
            ...
            <div class="col-md-6 col-lg-4 mb-3" v-for="product in products" :key="product.id">
              <div class="card border-0 shadow-sm h-100" data-aos="fade-up">
                ...
                <div class="card-body p-4 d-flex justify-content-between align-items-center">
                  ...
                  <a class="btn">
                    <i class="bi bi-cart-plus-fill h2" style="right: 16px; top: 16px" @click="addToCart(product.id)"></i>
                  </a>
                </div>
              </div>
            </div>
