<template>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top py-3">
      <div class="container-md">
         <router-link class="logo h1 text-decoration-none text-light me-5" to="/">Pomme</router-link>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
               <li class="nav-item">
                  <router-link to="/" class="nav-link fw-bold"
                     :class="{ 'text-secondary': this.$route.path === '/' }">首頁</router-link>
               </li>
               <li class="nav-item">
                  <router-link to="/menu" class="nav-link fw-bold"
                     :class="{ 'text-secondary': this.$route.path === '/menu' }">美味菜單</router-link>
               </li>
               <li class="nav-item">
                  <router-link to="/products" class="nav-link fw-bold"
                     :class="{ 'text-secondary': this.$route.path === '/products' }">線上商店</router-link>
               </li>
               <li class="nav-item">
                  <router-link to="/news" class="nav-link fw-bold"
                     :class="{ 'text-secondary': this.$route.path === '/news' }">最新消息</router-link>
               </li>
               <li class="nav-item">
                  <router-link to="/access" class="nav-link fw-bold"
                     :class="{ 'text-secondary': this.$route.path === '/access' }">交通方式</router-link>
               </li>
            </ul>
            <ul class="navbar-nav mb-2 mb-lg-0">
               <li class="nav-item">
                  <router-link to="/cart" class="nav-link position-relative d-none d-lg-block"
                     ...
                     <span class="badge rounded-pill bg-danger position-absolute top-0 start-50">{{ cart.length }}</span>
                  </router-link>
                  <router-link to="/cart" class="nav-link d-lg-none"
                     :class="{ 'text-secondary': this.$route.path === '/cart' }">
                     購物車 ({{ cart.length }})
                  </router-link>
               </li>
   ...
   <footer>
         ...
         <div class="container-md">
            <div class="py-5">
               <p class="mb-3 fw-bold text-center text-md-start" data-aos="fade-up" data-aos-duration="800">
                  訂閱電子報獲取我們的最新消息！</p>
               <VeeForm class="w-md-50 mt-md-0 mt-3" v-slot="{ errors }" @submit="subscribe" data-aos="fade-up"
      ...
      <div class="bg-primary pt-5 pb-4">
         <div class="container">
            <div class="d-flex align-items-center justify-content-center justify-content-sm-between mb-md-7 mb-4">
               ...
               <div class="d-none d-sm-inline">
                  <ul class="d-flex list-unstyled mb-0 fs-3">
                     ...
                     <li class="float-hover"><a href="https://github.com/Hamajibashi/pomme" target="_blank" class="text-white mx-3"><i class="bi bi-github"></i></a></li>
            ...
            <div class="d-flex justify-content-center justify-content-sm-between text-light">
               <ul class="list-unstyled">
                  ...
                  <li class="mb-2">
                     <a href="mailto:pommecage@mail.com" class="text-decoration-none text-light">
