<template>
    ...
    <div style="background-image: url('https://images.unsplash.com/photo-1530088172039-5aa64cd6d3b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80'); height:300px; background-size:cover; background-position:center center; background-attachment:fixed;"
            ...
            <div class="row flex-column flex-lg-row align-items-center align-items-lg-stretch">
                ...
                <div class="col-lg-5">
                    <div class="d-flex flex-column justify-content-between" data-aos="fade-up" data-aos-once="true">
                        ...
                        <p class="border-bottom pb-2 mb-3 fs-7" data-aos="fade-up" data-aos-duration="800"
                            data-aos-once="true">★我們一歲了！結帳時輸入 <span class="text-danger">Pomme1Year</span> 即可享有 8 折優惠！</p>
